...
public class ArrayListConcepts {
	...
	public static void main(String[] args) {
		...
		// Iterando con for each y funcion lambda
		...
		// El pase d edato de los objetos es por referencia
		// Es necesariio usar clone() para que las colecciones sean independientes
		
		// ArrayList<String> books = nombreLibros; // estoy pasando la referencia
		ArrayList<String> books = (ArrayList<String>) nombreLibros.clone(); // colecciones
