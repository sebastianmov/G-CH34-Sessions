...
public class ArrayConcepts {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Se instancia un arreglo con new tipoDato[numeroDeElementos];
		 */
		
		// Definimos un arreglo de 3 elementos tipo int.
		// Instanciando un objeto (array) de tipo Array, con 4 elementos
		// El indice es base 0, es decir, el primer elemento es el indice 0
		...
		// Agregar el codigo hexadecimal del color azul en el array codigoColores, index 0
		codigoColores[0] = 0x0000FF;
		
		// Agregar el amarillo en el indice 1 de los dos arrays
		nombreColores[1] = "Amarillo";
		codigoColores[1] = 0xFFFF00;
		
		// Agregar el color negro en el indice 2 de los dos arrays
